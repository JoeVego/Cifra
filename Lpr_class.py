    ...
    def detect_lpr(self):
        ...
        for results in preds:
            ...
            for result in results:
                ...
                # для разных камер(зон) разный триггер
                ...
                if y_center > 280 and x_center > 250:
                    # получаю область ББ обнаруженного объекта
                    ...
                    # передача в NN
                    try:
                        lic_plate_resp = httpx.post("http://172.20.0.3:8182/send-image",
                                                    json={"image_base64": base64_cv2_enc},
                                                    timeout=600.0)
